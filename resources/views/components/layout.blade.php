...
<body class="mb-48 max-w-screen-2xl mx-auto">
...
<footer
    class="fixed bottom-0 w-full max-w-screen-2xl mx-auto flex items-center justify-start font-bold bg-laravel text-white h-24 mt-24 opacity-90 md:justify-center">
